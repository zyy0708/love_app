    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow-lg p-6">
          ...
          <p class="text-sm text-gray-500">在一起的每一天都值得记录</p>
        </div>

        <div v-if="aiSummary" class="bg-white rounded-lg shadow-lg p-6">
          <h3 class="text-lg font-semibold text-gray-800 mb-2">🤖 {{ summaryLabel }}</h3>
      ...
      <div class="space-y-4">
        ...
        <div v-else-if="loadError" class="text-center py-12 bg-white rounded-lg">
          ...
          <button @click="loadEntries" class="mt-2 text-pink-600 hover:underline">重试</button>
        </div>

        <!-- 空状态 -->
        <div v-else-if="entries.length === 0" class="text-center py-12 bg-white rounded-lg">
